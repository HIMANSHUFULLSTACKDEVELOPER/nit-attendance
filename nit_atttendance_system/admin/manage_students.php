                    ...
                    <select name="class_id" required style="width: 100%; padding: 12px;">
                        ...
                        ?>
                            <option value="<?php echo $class['id']; ?>">
                                <?php 
                                // Display readable format with emojis
                                $section_names = [
                                    'Civil' => 'ðŸ—ï¸ Civil Engineering',
                                    'Mechanical' => 'âš™ï¸ Mechanical Engineering',
                                    'CSE-A' => 'ðŸ’» Computer Science - A',
                                    'CSE-B' => 'ðŸ’» Computer Science - B',
                                    'Electrical' => 'âš¡ Electrical Engineering'
                                ];
                                
                                // Check if section has a predefined name
