...
-- Database Name: nitcollege_attendance_system
-- Author: [Your Name]
-- Description: Full SQL schema with sample data.
...
-- =====================================================
-- 3️⃣ Users Table (Admin, HOD, Teachers)
-- =====================================================
CREATE TABLE users (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
-- =====================================================
-- 4️⃣ Classes Table (✅ Duplicate sections allowed)
-- =====================================================
CREATE TABLE classes (
    ...
    -- ❌ Removed UNIQUE constraint so duplicate sections are allowed
);
...
-- Classes (✅ Now duplicate section names like 'A' are allowed)
...
('CSE - 2nd Year - Section A', 1, 2, 'A', 5, 3, '2024-25'), -- duplicate section A allowed
('CSE - 2nd Year - Section B', 1, 2, 'B', 4, 3, '2024-25'),
...
('CSE2023002', 'Priya Gupta', 'priya.gupta@student.nitcollege.edu', '9876543221', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 2, 2, 3, '2023'),
('CSE2023003', 'Amit Kumar', 'amit.kumar@student.nitcollege.edu', '9876543222', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 1, 3, 2, 3, '2023'),
('ECE2022001', 'Vikram Rao', 'vikram.rao@student.nitcollege.edu', '9876543224', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 2, 4, 3, 5, '2022');
...
(2, 2, CURDATE(), 'present', 5),
(3, 3, CURDATE(), 'absent', 4),
(4, 4, CURDATE(), 'late', 6);
